 ...
 */
public class ThreadWaitTableView extends AbstractSegmentStoreTableView {
    ...
    /** The view's ID */
    public static final String ID = "org.eclipse.tracecompass.analysis.os.linux.views.threadwait.table"; //$NON-NLS-1$
    ...
    protected AbstractSegmentStoreTableViewer createSegmentStoreViewer(TableViewer tableViewer) {
        return new ThreadWaitTableViewer(tableViewer);
    }
}
