...
public abstract class AbstractSegmentStoreAnalysisModule extends TmfAbstractAnalysisModule implements ISegmentStoreProvider {
    ...
    /* (non-Javadoc)
     * @see org.eclipse.tracecompass.analysis.timing.core.segmentstore.ISegmentStoreProvider#getSegmentAspects()
     */
    @Override
    ...
    protected boolean executeAnalysis(IProgressMonitor monitor) throws TmfAnalysisException {
        ...
        ISegmentStore<ISegment> treeMap = new TreeMapStore<>();
        ...
        req = createAnalysisRequest(treeMap);
        fOngoingRequest = req;
        ...
        if (dataFileName != null) {
            ...
            try (ObjectOutputStream oos = new ObjectOutputStream(Files.newOutputStream(file))) {
                oos.writeObject(treeMap.toArray());
            } catch (IOException e) {
                /*
        ...
        for (IAnalysisProgressListener listener : getListeners()) {
            listener.onComplete(this, treeMap);
        }
